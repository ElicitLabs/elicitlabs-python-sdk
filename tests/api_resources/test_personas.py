...
class TestPersonas:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_list_linked(self, client: ElicitClient) -> None:
        persona = client.personas.list_linked(
            "user_id",
        )
        assert_matches_type(PersonaListLinkedResponse, persona, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_list_linked(self, client: ElicitClient) -> None:
        response = client.personas.with_raw_response.list_linked(
            "user_id",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_list_linked(self, client: ElicitClient) -> None:
        with client.personas.with_streaming_response.list_linked(
            "user_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_path_params_list_linked(self, client: ElicitClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `user_id` but received ''"):
            client.personas.with_raw_response.list_linked(
                "",
            )
...
class TestAsyncPersonas:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_list_linked(self, async_client: AsyncElicitClient) -> None:
        persona = await async_client.personas.list_linked(
            "user_id",
        )
        assert_matches_type(PersonaListLinkedResponse, persona, path=["response"])
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_list_linked(self, async_client: AsyncElicitClient) -> None:
        response = await async_client.personas.with_raw_response.list_linked(
            "user_id",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_list_linked(self, async_client: AsyncElicitClient) -> None:
        async with async_client.personas.with_streaming_response.list_linked(
            "user_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_path_params_list_linked(self, async_client: AsyncElicitClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `user_id` but received ''"):
            await async_client.personas.with_raw_response.list_linked(
                "",
            )
