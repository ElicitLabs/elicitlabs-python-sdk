...
from ...types.personas import link_create_params
from ...types.personas.link_create_response import LinkCreateResponse
from ...types.personas.link_delete_response import LinkDeleteResponse
...
class LinkResource(SyncAPIResource):
    ...
    def delete(
        ...
        *,
        ...
        """Remove a user's link to a persona.

        The user will no longer see the persona's
        memories.
        ...
        return self._delete(
            path_template("/v1/personas/{persona_id}/link/{user_id}", persona_id=persona_id, user_id=user_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=LinkDeleteResponse,
        )
