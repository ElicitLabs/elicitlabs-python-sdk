    ...
    def clone(
        ...
        *,
        ...
        Args:
          ...
          callback_url: Optional callback URL to receive a notification when the clone completes.
          ...
          notification_email: Optional email address to receive a notification when the clone completes.
